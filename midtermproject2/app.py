...
"""### Regional Focus – Texas (TX)

This chart displays the most popular fast food brands in Texas.  
We can see whether national leaders such as McDonald’s dominate, or if Texas has its own regional preferences.  
...
**Observation:**  
The most common fast food brand in the U.S. is McDonald’s, followed by Burger King and Taco Bell.  
...
**Observation:**  
In California, McDonald’s is still the leader, but regional chains may also appear in the top 10 depending on the state.  
...
# Title
st.title("🍔 Fast Food Brand Explorer (USA)")
...
st.pyplot(fig)
st.caption("Data source: Kaggle – Fast Food Restaurants Across America")
